...
| Exact — Keeps the source timestamp | 6 | Pass |
...
Field names, counters, dates, and sample values are data rather than product
copy. Short controls are included where their wording carries meaning.
